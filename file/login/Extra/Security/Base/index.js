...
if (!fs.existsSync(process.cwd() + '/main/json') || !fs.existsSync(process.cwd() + '/main/json/RandPass.json')) {
  ...
  if (!fs.existsSync(process.cwd() + '/main/json')) {
    fs.mkdirSync(process.cwd() + '/main/json');
  }
  fs.writeFileSync(process.cwd() + '/main/json/RandPass.json', JSON.stringify(ArrPassWord, null, 2), 'utf8');
}

else {
  ArrPassWord = JSON.stringify(fs.readFileSync(process.cwd() + '/main/json/RandPass.json'));
}
