...
if (!fs.existsSync(process.cwd() + '/main/db/sqlite')) {
    fs.mkdirSync(process.cwd() + '/main/db/sqlite');
}
var db = new BetterDB(process.cwd() + "/main/db/sqlite/SyntheticDatabase.sqlite");
