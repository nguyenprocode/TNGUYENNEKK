module.exports = function ({ models, api }) {
  ...
  async function getAll(...data) {
    ...
    for (const i of data) {
      if (typeof i != 'object') throw "Cần một đối tượng hoặc một mảng.";
  ...
  async function setData(userID, options = {}) {
    if (typeof options != 'object' && !Array.isArray(options)) throw "Cần một đối tượng.";
    try {
  ...
  async function createData(userID, defaults = {}) {
    if (typeof defaults != 'object' && !Array.isArray(defaults)) throw "Cần một đối tượng.";
    try {
