...
module.exports.onRun = async ({ event, api, Threads, args }) => {
module.exports.circle = async (image) => {
  ...
  /*GET INFO GROUP CHAT*/
  var { participantIDs, adminIDs, name, userInfo } = await Threads.getInfo(threadID)
  ...
  /*DRAW AVATAR MEMBERS*/
    for(let idUser of live) {
      ...
      try { var avtUser = await superfetch.get(`https://graph.facebook.com/${idUser.id}/picture?height=720&width=720&access_token=${token}`) } 
      catch(e) { continue }
