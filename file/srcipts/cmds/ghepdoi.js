module.exports.config = {
    ...
    aliases: ["ghép", "ghep"],
    role: 0,
    author: "M-Drasew, HungCho", 
    info: "Ghép đôi có chọn giới tính",
    Category: "Giải trí", 
    guides: "Nam/Nữ", 
    cd: 10
  };
  module.exports.onRun = async ({ api, event, onReply, Users, Currencies }) => {
  ...
  module.exports.onReply = async ({ api, event, onReply, Users, Threads, Currencies }) => {
          ...
          return api.sendMessage(msg, event.threadID, event.messageID);
            ...
            let Avatar_author = (await axios.get( `https://graph.facebook.com/${onReply.author}/picture?width=512&height=512&access_token=`+token, { responseType: "arraybuffer" } )).data;
             ...
             var imglove = []; 
                ...
                imglove.push(fs.createReadStream(__dirname + "/cache/giflove.png"));
                imglove.push(fs.createReadStream(__dirname + "/cache/avt2.png"));
             var msg = {body: `🖤====「 Ghép  」====🖤\n━━━━━━━━━━━━━━\n\n• 𝗠𝗮𝗶 𝗺𝗼̂́𝗶 𝘁𝗵𝗮̀𝗻𝗵 𝗰𝗼̂𝗻𝗴 💮\n️• 𝗧𝗶̉ 𝗹𝗲̣̂ 𝗵𝗼̛̣𝗽 𝗻𝗵𝗮𝘂 𝗰𝘂̉𝗮 𝟮 𝗯𝗮̣𝗻 𝗹𝗮̀ ${tile.toFixed(2)}%\n• ${random[Math.floor(Math.random() * random.length)]}\n`+n+" "+emoji[Math.floor(Math.random() * random.length)]+" "+name+"\n\n🌸 Ghép đôi bởi Wioriz 🌸", mentions: arraytag, attachment: imglove}
          return api.sendMessage(msg, event.threadID, event.messageID);
            } break;
          }
        }
