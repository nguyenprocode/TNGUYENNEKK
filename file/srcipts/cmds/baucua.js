var request = require("request");const { readdirSync, readFileSync, writeFileSync, existsSync, copySync, createWriteStream, createReadStream } = require("fs-extra");
    module.exports.config = {
        ...
        version: "1.0.0",
        role: 0,
        author: "Horizon Lucius Synthesis I",
        info: "Cược bầu cua",
        Category: "Game",
        guides: "baucua + tên + tiền :v",
        cd: 5
    };
...
var full = [];
    module.exports.onRun = async function({ api, event, args, Currencies }) { var out = (msg) => api.sendMessage(msg,event.threadID, event.messageID);
