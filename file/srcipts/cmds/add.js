module.exports.config = {
  ...
  role: 1,
  author: "D-Jukie",
  info: "Thêm người dùng vào nhóm bằng link hoặc uid",
  Category: "Box chat",
  guides: "[args]",
  cd: 0
};
this.onRun = async function ({ api, event, args, Threads, Users }) {
const { threadID, messageID } = event;
const axios = require('axios')
const link = args.join(" ")
if(!args[0]) return api.sendMessage('', threadID, messageID);
var { participantIDs, approvalMode, adminIDs } = await Threads.getInfo(threadID);
