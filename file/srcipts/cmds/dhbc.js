  const coinsup = 20000 //thay số coins được nhận khi đoán trúng
...
module.exports.config = {
    ...
    role: 0,
    author: "1",
    info: "Đuổi hình bắt chữ trên chính messenger của bạn!!!",
    Category: "Game",
    guides: "[1/2]",
    cd: 10
};
...
module.exports.onRun = async function ({
    ...
    if ((this.config.author) != "1") { return api.sendMessage(`⚡️Phát hiện credits đã bị thay đổi`, event.threadID, event.messageID)}
    if (!args[0]) {
